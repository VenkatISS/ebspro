...
/*		res=checkRefNoAndProduct(formobj,cvtype,crefno,parsedOmcVal);
		...
		ems = validateEntries(nidate,cvtype,cvoid,item,egst,tamt,igst,cgst,sgst,camt,nbid,nreason);
...
function validateEntries(nidate,cvtype,cvoid,item,egst,tamt,igst,cgst,sgst,camt,nbid,nreason) {
