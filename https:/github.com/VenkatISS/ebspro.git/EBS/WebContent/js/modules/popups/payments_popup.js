...
document.getElementById("insd").innerHTML = page_data.instr_details;
document.getElementById("cinsd").innerHTML = page_data.instr_details;
var cust_ven=page_data.cust_ven;


document.getElementById("narr").innerHTML = page_data.narration;
document.getElementById("cnarr").innerHTML = page_data.narration;


 var pmode=page_data.payment_mode;
 if(pmode==1){
document.getElementById("mpmt").innerHTML ="CASH";
 document.getElementById("cmpmt").innerHTML ="CASH";
 }
 else if(pmode==2){
 document.getElementById("mpmt").innerHTML ="CHEQUE";
 document.getElementById("cmpmt").innerHTML ="CHEQUE";
 }
 else if(pmode==3){
 document.getElementById("mpmt").innerHTML ="ONLINE TRANSFER";
 document.getElementById("cmpmt").innerHTML ="ONLINE TRANSFER";
 }


var ed = new Date(page_data.pymt_date);
...
document.getElementById('invamnt').innerHTML = (parseFloat(page_data.pymt_amount)).toFixed(2);
document.getElementById('cinvamnt').innerHTML = (parseFloat(page_data.pymt_amount)).toFixed(2);

var invamount=(parseFloat(page_data.pymt_amount)).toFixed(2);
...
for(var j=0; j<cvo_data.length;j++) {
	var custName = getCustomerName(cvo_data,page_data.paid_to);
	if(cust_ven==3){
	document.getElementById("cnamespan1").innerHTML= "GST";
	document.getElementById("ccnamespan1").innerHTML= "GST";
	document.getElementById("cnamespan2").innerHTML= "GST";
	document.getElementById("ccnamespan2").innerHTML= "GST";
	}
	else{
