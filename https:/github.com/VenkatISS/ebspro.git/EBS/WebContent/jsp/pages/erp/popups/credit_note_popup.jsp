...
<jsp:useBean id="cnp_data" scope="request" class="java.lang.String"></jsp:useBean>
<script type="text/javascript" src="js/commons/rupeeConvStValidation.js"></script>
...
var prod_types = <%= prod_types_list.length()>0? prod_types_list : "[]" %>;
var page_data = <%= cnp_data.length()>0? cnp_data : "[]" %>;
								...
								<table id="m_data_table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 14px;">
									<thead>
										<tr bgcolor="#808B96" height="30px">
											...
											<th><font size=1 color="white" face="tahoma">QUANTITY</font></th>
											<th><font size=1 color="white" face="tahoma">UNITS</font></th>
...
<script type="text/javascript" src="js/modules/popups/credit_note_popup.js"></script>
</html>