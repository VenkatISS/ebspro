...
<html>
    ...
    <title>MyLPGBooks DEALER WEB APPLICATION - NC/DBC PACKAGING </title>
								...
								<div>
									<form id="data_form" name="" method="post" action="TransactionsDataControlServlet">
										...
										<span>
											...
											&nbsp&nbsp&nbsp
											<input type="radio" id="ctypeul" name="ctype" value="3" style="margin: 7px;">UJWALA  LOAN NC 
											&nbsp&nbsp&nbsp
											<input type="radio" id="ctypeuc" name="ctype" value="4" style="margin: 7px;">UJWALA  CASH NC 
											&nbsp&nbsp&nbsp
