...
<title><%=agencyVO.getGstin_no()+"-"+"DELIVERY CHALLAN"+"-"+request.getAttribute("dateyear")%></title>
...
<jsp:useBean id="dcs_data" scope="request" class="java.lang.String"></jsp:useBean>
...
var page_data = <%= dcs_data.length()>0? dcs_data : "" %>;
...
<body style="width: 93%;padding: -1px;margin-left:25px;">
	<table style="width: 90%; margin-left:70px">
		<tr valign="top">
			<td><br><br><br>
			<center><span style="font-size:17px;">DELIVERY CHALLAN</span></center>
							...
							<table style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 12px;padding: 10px;" class="table">
								<tr valign="top">
									<td width="50%" style="border: 1px solid;border-color: #808B96;font-size: 12px;" class="td">
										...
										INVOICE REF NUMBER : <span id="invrefid"></span> <br>
										INVOICE REF DATE : <span id="invrefdate"></span> <br>									
									</td>
									<td width="50%" style="border: 1px solid;border-color: #808B96;font-size: 12px;" class="td">
										<label style = "margin-right:180px">MODE OF TPT : BY ROAD</label><br>
										<label>VEHICLE NO : <span id="vno"></span></label><br>
										<label style = "margin-right:120px">DATE&TIME OF SUPPLY: <span id="dats"></span></label><br> 
								...
								<table id="data_table2" class="table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 14px;padding: 10px;">
									<tr class="tr">
									 <td>
										<table>
											<!-- <tr>
												<td colspan="3" style="font-size: 14px;">AMOUNT OF TAX SUBJECT TO REVERSE CHARGES : <b><span id="revc"></span></b><br></td>
											</tr> -->											
											<tr valign="top">
												<td colspan="3" style="font-size: 14px;">TOTAL INVOICE AMOUNT (In Words) : <b><span id="invamtwords"></span></b><br><br></td>
											</tr>
											<tr valign="top">
												<td colspan="3" style="font-size: 14px;">NARRATION : <b><span id="nars"></span></b><br><br></td>
											</tr>											
											<tr valign="top">
									...
									<td>									
										<table id="data_table3" class="table" style="width: 100%;margin-left: -1%;border: 1px solid;border-color: #808B96;font-size: 15px;padding: 10px;border-collapse:collapse;">
										 	<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 14px;">TAXABLE : 
												<b><span id="taxableVal" style="font-size: 14px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 14px;">IGST :
												<b><span id="igstVal" style="font-size: 14px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 14px;">CGST :
												<b><span id="cgstVal" style="font-size: 14px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 14px;">SGST :
...
<script type="text/javascript" src="js/modules/popups/delivery_challan_popup.js?<%=randomUUIDString%>"></script>
</html>
