					...
					<ul id="nav" class="nav nav-pills clearfix right" role="tablist">
          				<li class="dropdown"><span class="dropdown-toggle  btn-info" data-toggle="dropdown" id="ahelp">Help</span>
							<ul id="products-menu" class="dropdown-menu clearfix" role="menu">
								<li><a style="font-size: 14px;" title="commercial-cylinder-sales"href="https://www.youtube.com/watch?v=0hV6CvbNOhA" target="_blank">English</a></li>
								<!-- <li><a style="font-size: 14px;" href="https://www.youtube.com/watch?v=0hV6CvbNOhA" target="_blank">Hindi</a></li> -->
							</ul>
						</li>
					</ul>
        		</div>
...
<!-- 					  			<h4 class="modal-title">COMMERCIAL CYLINDER SALES</h4> -->
								<b>	COMMERCIAL CYLINDER SALES</b><button name="cvo_pop1" id="cvo_pop1" class=" btn-info color_popup_btn bg_color4 btnr" onclick="showCVOFormDialog()">CVO</button>
            	...
            	<div class="main_table"  style="margin-left: 37px;margin-right:37px;">
              		<div class="table-responsive">
             	 		<form id="mcvopopup_data_form" name="" method="post" action="MasterDataControlServlet">
							...
							<input type="hidden" id="dataId" name="dataId" value="">
							<input type="hidden" id="popupPageId" name="popupPageId" value="2">
...
<!-- 		<button name="mcvo_cancel_data" id="mcvo_cancel_data"	class="btnr btn-info color_popup_btn bg_color2" onclick="doAction('MasterDataControlServlet','jsp/pages/erp/transactions/sales/com_refill_sales.jsp','5126')">BACK PAGE</button> -->
...
<!-- 				<button name="mequipopup_cancel_data" id="mequipopup_cancel_data"	class="btnr btn-info color_popup_btn bg_color2" onclick="doAction('MasterDataControlServlet','jsp/pages/erp/transactions/sales/com_refill_sales.jsp','5126')">BACK PAGE</button> -->
				<div class="row">
          			<div class="clearfix"></div>
          			<div class="col-md-15">
            			<div class="main_table" style="margin-left: 37px;margin-right:37px;">
...
<!-- 			<button name="cancel_refillpricedata" id="cancel_refillpricedata"	class="btnr btn-info color_popup_btn bg_color2" onclick="doAction('MasterDataControlServlet','jsp/pages/erp/transactions/sales/com_refill_sales.jsp','5126')">BACK PAGE</button> -->
...
<!--                   			<button name="prof_submit_mRefilpricepopup_btn" id="prof_submit_mRefilpricepopup_btn" class="btn btn-success m-r-15" onclick="doAction('MasterDataControlServlet','jsp/pages/erp/transactions/sales/com_refill_sales.jsp','5126')">BACK</button> -->
                  		</div>
                  		</form>
                	</div>
                </div>
...
<!-- 			<button name="mbbankpopup_cancel_data" id="mbbankpopup_cancel_data" class="btnr btn-info color_popup_btn bg_color2" onclick="doAction('MasterDataControlServlet','jsp/pages/erp/transactions/sales/com_refill_sales.jsp','5126')">BACK PAGE</button> -->
...
<!-- 				<button name="cancel_mstaffpopup_data" id="cancel_mstaffpopup_data"	class="btnr btn-info color_popup_btn bg_color2" onclick="doAction('MasterDataControlServlet','jsp/pages/erp/transactions/sales/com_refill_sales.jsp','5126')">BACK PAGE</button> -->
              				...
              				<div class="table-responsive">
								<form id="mareacode_page_data_form" name="" method="post" action="PPMasterDataControlServlet">
									...
									<table class="table" id="page_add_table">
                  						...
                  						<tbody id="mareacode_page_add_table_body">
                  						</tbody>
                   					</table>
                				</form>
              				</div>
...
<!-- 				<button name="mareacode_cancel_data" id="mareacode_cancel_data"	class="btnr btn-info color_popup_btn bg_color2" onclick="doAction('MasterDataControlServlet','jsp/pages/erp/transactions/sales/com_refill_sales.jsp','5126')">BACK PAGE</button> -->
				<br><br>	
				<div class="row">
          			<div class="clearfix"></div>
          			<div class="col-md-15">
            			<div class="main_table" style="margin-left: 37px;margin-right:37px;">
              				<div class="table-mpopup_responsive">
                				<table class="table  table-striped" id="mareacode_popup_data_table">
                  					...
                  					<tbody id="mareacode_page_data_table_body">
                  					</tbody>
                				</table>
              				</div>
            			</div>
