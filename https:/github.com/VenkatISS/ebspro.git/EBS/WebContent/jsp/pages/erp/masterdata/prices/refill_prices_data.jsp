...
<html>
  ...
  <head>
    ...
    <title>REFILL PRICE MASTER</title>
...
<%-- 	<script src="js/commons/checkBrowser.js?<%=randomUUIDString%>"></script>     --%>
	...
	<script type="text/javascript">
		...
		var page_data =  <%= refill_prices_data.length()>0? refill_prices_data : "[]" %>;
	</script>
...
<!--     	<div id = "dialog-1" title="Alert(s)"></div>
        ...
        <div class="page-title">
			<div>
				<h1>REFILL PRICE MASTER </h1>
        	</div>
			<ul id="nav" class="nav nav-pills clearfix right" role="tablist">
          		<li class="dropdown"><span class="dropdown-toggle  btn-info" data-toggle="dropdown" id="ahelp">Help</span>
					<ul id="products-menu" class="dropdown-menu clearfix" role="menu">
						<li><a style="font-size: 14px;" title="Refill Price Setting" href="https://www.youtube.com/watch?v=WY8wffDUcwA" target="_blank">English</a></li>
						<li><a style="font-size: 14px;" href="https://youtu.be/B3ss1zawWb8" target="_blank">Hindi</a></li>
					</ul>
				</li>
			</ul>
        </div>
            ...
            <div class="main_table">
              <div class="table-responsive">
				<form id="page_data_form" name="" method="post" action="PPMasterDataControlServlet">
					...
					<input type="hidden" id="page" name="page" value="jsp/pages/erp/masterdata/prices/refill_prices_data.jsp">
        ...
        <span id="refillOfpNote" style="display:none;color:red;"> * Please &nbspenter &nbspOFFER PRICE &nbspalong &nbspwith &nbspit's &nbspGST &nbspamount.</span>
                ...
                <table class="table  table-striped" id="page_data_table">
                  <thead>
                    <tr class="title_head">
                       ...
                       <th width="20%" class="text-center sml_input">OFFER PRICE</th>
	...
	<script type="text/javascript" src="js/modules/masterdata/prices/refill_prices_data.js?<%=randomUUIDString%>"></script> 
	<script>
