...
<title><%=agencyVO.getGstin_no()+"-"+"OTV/TTV/TV"+"-"+request.getAttribute("dateyear")%></title>
...
<body style="width: 93%;padding: -1px;margin-left:25px;">
	<table style="width: 90%; margin-left:70px">
		<tr valign="top">
			<td><br><br>
			<center><span style="font-size:15px;">OTV / TTV /TV</span></center>
				...
				<table style="width: 100%; border: 1px solid block; border-spacing: 0; border-collapse: 0;padding: -1px;margin: -1px; font-size: 12px;" class="table">
					<tr valign="top">
						...
						<%} %>							
							...
							<!--  DISPLAY STARTS HERE -->
							<table style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 11px;padding: 10px;" class="table">
								<tr valign="top">
							...
							<div id="data_table" class="row">
								<table id="m_data_table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 13px;">
									<thead>
										<tr bgcolor="#808B96" height="30px">
											...
											<th><font size=1 color="white" face="tahoma">IMPREST <br> AMOUNT</font></th>
											...
											<th><font size=1 color="white" face="tahoma"> GST </font></th>
											<th><font size=1 color="white" face="tahoma"> TOTAL<br>REFUND </font></th>
										</tr>
									</thead>
								...
								<table id="data_table2" class="table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 12px;padding: 8px;">
									 ...
									 <td>
										<table>
											<tr>
 											...
 											<tr>
												<td style="font-size: 12px;">LESS IMPREST AMOUNT DEDUCTED: <span id="impa"></span></td>
 											</tr>
											<tr>
												<td style="font-size: 12px;">LESS SERVICE CHARGES : <span id="tamt"></span></td>
 											</tr>
											<tr>
												<td style="font-size: 12px;">TOTAL REFUNDED AMOUNT (In Figure):
												<b><span id="tinvamt" style="font-size: 13px;"></span></b></td>
											</tr>
 											<tr>
												<td style="font-size: 12px;">TOTAL INVOICE AMOUNT (In Words) : <b><span id="invamtwords"></span></b> </td>
 											</tr>
											<tr><td>&nbsp</td></tr>
											<tr><td>&nbsp</td></tr>
											<tr><td>&nbsp</td></tr>
									...
									<td>
										<table id="data_table3" class="table" style="width: 100%;margin-left: -1%;border: 1px solid;border-color: #808B96;font-size: 12px;padding: 10px;border-collapse:collapse;">
										 	<tr>
											...
											<tr>
												...
												<span id="tamt1" style="font-size: 13px;"></span></b></td>
											</tr>
										</table>
									</td>
									</tr>
									...
									<br>
					       			<div align="left">CUSTOMER SIGNATURE </div>
								...
								<table id="cm_data_table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 13px;">
									<thead>
										<tr bgcolor="#808B96" height="30px">
											...
											<th><font size=1 color="white" face="tahoma"> GST % </font></th>
											<th><font size=1 color="white" face="tahoma"> GST </font></th>
											<th><font size=1 color="Black" face="tahoma"> TOTAL<br>REFUND </font></th>
										</tr>
									</thead>
								...
								<table id="data_table2" class="table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 12px;padding: 8px;">
									 ...
									 <td>
										<table>
											<tr>
 											...
 											<tr>
												<td style="font-size: 12px;">LESS IMPREST AMOUNT DEDUCTED: <span id="cimpa"></span></td>
 											</tr>
											<tr>
												<td style="font-size: 12px;">LESS SERVICE CHARGES : <span id="ctamt"></span></td>
 											</tr>
											<tr>
												<td style="font-size: 12px;">TOTAL REFUNDED AMOUNT (In Figure):
												<b><span id="ctinvamt" style="font-size: 13px;"></span></b></td>
											</tr>
 											<tr>
												<td style="font-size: 12px;">TOTAL INVOICE AMOUNT (In Words) : <b><span id="cinvamtwords"></span></b> </td>
 											</tr>
											<tr><td>&nbsp</td></tr>
											<tr><td>&nbsp</td></tr>
											<tr><td>&nbsp</td></tr>
									...
									<td>
										<table id="data_table3" class="table" style="width: 100%;margin-left: -1%;border: 1px solid;border-color: #808B96;font-size: 13px;padding: 8px;border-collapse:collapse;">
											...
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 13px;"><b>TOTAL :
												<span id="ctamt1" style="font-size: 13px;"></span></b></td>
											</tr>
										</table>
									</td>
									</tr>
...
<script type="text/javascript" src="js/modules/popups/tv_popup.js?<%=randomUUIDString%>"></script>
</html>