...
<jsp:useBean id="prs_data" scope="request" class="java.lang.String"></jsp:useBean>
...
var page_data = <%= prs_data.length()>0? prs_data : "[]" %>;
						...
						<%} %>							
							...
							<table style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 12px;padding: 10px;" class="table">
								<tr valign="top">
									...
									VEHICLE NO : <span id="vno"></span>
									<br>
									<label style = "margin-right:120px">DATE&TIME OF RETURN: <span id="datr"></span></label> <br>
								...
								<table id="m_data_table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 14px;">
									<thead>
										<tr bgcolor="#808B96" height="30px">
											...
											<th><font size=1 color="white" face="tahoma">NET WEIGHT</font></th>											
...
<script type="text/javascript" src="js/modules/popups/purchase_return_popup.js?<%=randomUUIDString%>"></script>
</html>