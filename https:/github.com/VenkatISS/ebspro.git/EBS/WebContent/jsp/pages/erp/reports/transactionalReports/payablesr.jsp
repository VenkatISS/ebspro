...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/buttons/1.5.1/css/buttons.dataTables.min.css">
	  	...
	  	<title>MyLPGBooks DEALER APPLICATION - PAYABLES REPORTS</title>
		...
		<jsp:useBean id="svenid" scope="request" class="java.lang.String"></jsp:useBean>
      		...
      		<div class="content-wrapper">
        		...
        		<div class="row">
		        	<div class="clearfix"></div>
		          	<div class="col-md-15">
		  				<form id="payables_search_form" name="" method="post" action="ReportsDataControlServlet">
							<input type="hidden" id="agencyId" name="agencyId" value="<%= agencyVO.getAgency_code() %>">
							<input type="hidden" id="page" name="page" value="jsp/pages/erp/reports/transactionalReports/payablesr.jsp">
							<input type="hidden" id="actionId" name="actionId" value="7362">
...
<!--   								<input type="date" class="form-control input_field" id="ad" name="ad">
 --> 		                        <%Date date = new Date();
  						...
  						<button onclick="fetchPayablesReport(payables_search_form)" id="searchb" name="searchb" class="btn btn-info color_btn" style="margin-top:20px;">SEARCH</button>
		  			</div>
				</div>
				<br/>
				<div class="row">
	     			<div class="clearfix"></div>
	     		 	 <div class="col-md-12"> 
	      				<div id="data_div" style="display: none;">
	       						<b>DATE:</b>&nbsp<span id="pbSpan"></span>
								<table class="table table-striped" id="m_data_table">
        	      					<thead>
        	      							
				<tr class="title_head">
            	    					<tr class="title_head">
												<th width="10%" class="text-center sml_input">VENDOR NAME</th>
	...
	<script type="text/javascript" src="js/modules/reports/transactionalReports/payablesr.js?<%=randomUUIDString%>"></script>
