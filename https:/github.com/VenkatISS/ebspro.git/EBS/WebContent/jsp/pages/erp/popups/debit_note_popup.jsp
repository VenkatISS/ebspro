...
<jsp:useBean id="dnp_data" scope="request" class="java.lang.String"></jsp:useBean>
...
var page_data = <%= dnp_data.length()>0? dnp_data : "[]" %>;
...
<script type="text/javascript" src="js/modules/popups/debit_note_popup.js?<%=randomUUIDString%>"></script>
</html>