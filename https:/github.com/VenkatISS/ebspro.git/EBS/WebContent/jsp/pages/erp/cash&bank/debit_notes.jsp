...
<html>
    ...
    %>
  	<head>
    	...
    	<title>MyLPGBooks DEALER WEB APPLICATION - DEBIT NOTES</title>
		<jsp:include page="/jsp/pages/commons/sidenav.jsp"/>
		<jsp:useBean id="agencyVO" scope="session" class="com.it.erpapp.framework.model.vos.AgencyVO"></jsp:useBean>
		<jsp:useBean id="cvo_data" scope="request" class="java.lang.String"></jsp:useBean>
		<jsp:useBean id="dn_data" scope="request" class="java.lang.String"></jsp:useBean>
...
<%-- 		<script src="js/commons/checkBrowser.js?<%=randomUUIDString%>"></script>     --%>
		...
		<script type="text/javascript">
			var page_data = <%= dn_data.length()>0? dn_data : "[]" %>;
					...
					<ul id="nav" class="nav nav-pills clearfix right" role="tablist">
          				<li class="dropdown"><span class="dropdown-toggle  btn-info" data-toggle="dropdown" id="ahelp">Help</span>
							<ul id="products-menu" class="dropdown-menu clearfix" role="menu">
								<li><a style="font-size: 14px;" href="https://www.youtube.com/watch?v=XxtWtzM7CUQ" target="_blank">English</a></li>
								<!-- <li><a style="font-size: 14px;" href="https://www.youtube.com/watch?v=XxtWtzM7CUQ" target="_blank">Hindi</a></li> -->
							</ul>
						</li>
					</ul>
        		</div>

				<button name="b_sb" id="b_sb" class="btn btn-info color_btn bg_color4" onclick="showDNFormDialog()">ADD</button>
					...
					<div class="modal-dialog modal-lg">
			  			...
			  			<div class="modal-content" id="modal-content">
							<div class="modal-header" id="modal-header">
					  			<span class="close" id="close" onclick="closeDNFormDialog()">&times;</span>
					  			<!-- <h4 class="modal-title">DEBIT NOTE(S)</h4> -->
					  			<!-- <b>DEBIT NOTE(S)</b> -->	
					  			
					  					  			<!-- -------------------------mstart--------------------- -->
   <b>DEBIT NOTE(S)</b><button name="cp_pop1" id="cp_pop1" class=" btn-info color_popup_btn bg_color4 btnr" onclick="showCPFormDialog()">CP</button>
...
<!-- -------------------------mend--------------------- -->
							...
							<div class="modal-body">
								<form id="data_form" name="" method="post" action="TransactionsDataControlServlet">
									...
									<input type="hidden" id="page" name="page" value="jsp/pages/erp/cash&bank/debit_notes.jsp">
									<input type="hidden" id="actionId" name="actionId" value="5542">
                  										...
                  										<tbody id="data_table_body">
                  											<tr>
                  												<td valign="top" height="4" align="center">
				   												...
				   												<td valign='top' height='4' align='center'><input type=text name='tamt' id='tamt' class='form-control input_field eadd qtyc freez' placeholder='TAXABLE AMOUNT'></td>
						...
						<form id="m_data_form" name="" method="post" action="MasterDataControlServlet">
							...
							<input type="hidden" id="itemId" name="itemId" value=""> 
           					<table class="table  table-striped" id="m_data_table">
           						<thead>
               						<tr class="title_head">
										<th width="10%" class="text-center sml_input">DEBIT<br>NOTE<br>NUMBER</th>
               							<th width="10%" class="text-center sml_input">DEBIT<br>NOTE<br>DATE</th>
...
<div id="dialog-confirm"><div id="myDialogText" style="color:black;"></div></div>
	...
	<script type="text/javascript" src="js/modules/cash&bank/debit_notes.js?<%=randomUUIDString%>"></script>
