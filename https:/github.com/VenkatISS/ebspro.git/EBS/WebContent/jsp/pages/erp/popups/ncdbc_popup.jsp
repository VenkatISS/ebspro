...
<jsp:useBean id="ncdbcs_data" scope="request" class="java.lang.String"></jsp:useBean>
...
var page_data = <%= ncdbcs_data.length()>0? ncdbcs_data : "" %>;
								...
								<table id="data_table2" class="table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 14px;padding: 10px;">
									...
									<td>
										<table id="data_table3" class="table" style="width: 100%;margin-left: -1%;border: 1px solid;border-color: #808B96;font-size: 15px;padding: 10px;border-collapse:collapse;">
											...
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 15px;"><b>TOTAL AMOUNT :
												<span id="tamt" style="font-size: 15px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 15px;"><b>SECURITY DEPOSIT :
												<span id="tsd" style="font-size: 15px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 15px;"><b>INVOICE AMOUNT :
...
<script type="text/javascript" src="js/modules/popups/ncdbc_popup.js?<%=randomUUIDString%>"></script>
</html>