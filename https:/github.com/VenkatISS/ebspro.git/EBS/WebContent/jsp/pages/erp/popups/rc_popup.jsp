...
<body style="width: 93%;padding: -1px;margin-left:25px;margin-top:-12px"">
				...
				<table style="width: 100%; border: 1px solid block; border-spacing: 0; border-collapse: 0;padding: -1px;margin: -1px; font-size: 12px;" class="table">
					<tr valign="top">
						...
						<%} %>							
							...
							<!--  DISPLAY STARTS HERE -->
							<table style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 11px;padding: 8px;" class="table">
								<tr valign="top">
									<td width="50%" style="border: 1px solid;border-color: #808B96;font-size: 10px;" class="td">
							...
							<div id="data_table" class="row">
								<table id="m_data_table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 12px;">
									<thead>
								...
								<table id="data_table2" class="table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 11px;padding: 8px;">
									<tr class="tr">
									 <td>
										<table>
											<tr>
									...
									<td>
										<table id="data_table3" class="table" style="width: 100%;margin-left: -1%;border: 1px solid;border-color: #808B96;font-size: 11px;padding: 8px;border-collapse:collapse;">
										 	<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;">TAXABLE <b>: 
												<span id="taxableVal" style="font-size: 12px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;">IGST <b>:
												<span id="igstVal" style="font-size: 12px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;">CGST <b>:
												<span id="cgstVal" style="font-size: 12px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;">SGST <b>:
												<span id="sgstVal" style="font-size: 12px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;"><b>TOTAL :
				...
				<table style="width: 100%; border: 1px solid block; border-spacing: 0; border-collapse: 0;padding: -1px;margin: -1px; font-size: 12px;" class="table">
					<tr valign="top">
						...
						<%} %>							
							...
							<div id="data_table" class="row">
								<table id="cm_data_table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 12px;">
									<thead>
										<tr bgcolor="#808B96" height="30px">
											<th><font size=1 color="white" face="tahoma">S.NO</font></th>
											<th><font size=1 color="white" face="tahoma">PRODUCT</font></th>
								...
								<table id="data_table2" class="table" style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 11px;padding: 8px;">
									<tr class="tr">
									 <td>
										<table>
											<tr>
												<td style="font-size: 11px;">TOTAL INVOICE AMOUNT :
												<span id="ctinvamt1"></span></td>
											</tr>
											<tr>
												<td style="font-size: 11px;">TOTAL SECURITY DEPOSIT AMOUNT : <span id="ctsda"></span></td>
 											</tr>
											<tr>
												<td style="font-size: 11px;">TOTAL AMOUNT : <span id="ctamt"></span></td>
 											</tr>
											<tr valign="top">
												<td colspan="3" style="font-size: 11px;">TOTAL AMOUNT (In Words) : <b><span id="cinvamtwords"></span></b><br><br></td>
											</tr>
											<tr valign="top">
												<td colspan="3" style="font-size: 11px;">DECLARATION :  This is system generated.Hence no stamp and signature is required.<br></td>
											</tr>
											<tr><td>&nbsp</td></tr>
											<tr><td>&nbsp</td></tr>
											<tr><td>&nbsp</td></tr>
									...
									<td>
										<table id="data_table3" class="table" style="width: 100%;margin-left: -1%;border: 1px solid;border-color: #808B96;font-size: 12px;padding: 8px;border-collapse:collapse;">
										 	<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;">TAXABLE <b>: 
												<span id="ctaxableVal" style="font-size: 11px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;">IGST <b>:
												<span id="cigstVal" style="font-size: 11px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;">CGST <b>:
												<span id="ccgstVal" style="font-size: 11px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 11px;">SGST <b>:
												<span id="csgstVal" style="font-size: 11px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 12px;"><b>TOTAL :
												<span id="ctinvamt" style="font-size: 12px;"></span></b></td>
											</tr>
										</table>
									</td>
									</tr>
