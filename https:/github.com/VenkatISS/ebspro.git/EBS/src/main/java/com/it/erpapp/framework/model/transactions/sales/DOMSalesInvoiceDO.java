...
@Entity
@Table(name="DOM_SALES_INVOICES")
public class DOMSalesInvoiceDO {
	...
	@Transient
	private List<DOMSalesInvoiceDetailsDO> detailsList = new ArrayList<DOMSalesInvoiceDetailsDO>();
	...
	public List<DOMSalesInvoiceDetailsDO> getDetailsList() {
		return detailsList;
	}
	public void setDetailsList(List<DOMSalesInvoiceDetailsDO> detailsList) {
