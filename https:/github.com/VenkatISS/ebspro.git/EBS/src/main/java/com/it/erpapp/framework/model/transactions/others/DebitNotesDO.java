...
public class DebitNotesDO {
	...
	public int getDebit_note_type() {
		return debit_note_type;
	}
	public void setDebit_note_type(int debit_note_type) {
		this.debit_note_type = debit_note_type;
	}
