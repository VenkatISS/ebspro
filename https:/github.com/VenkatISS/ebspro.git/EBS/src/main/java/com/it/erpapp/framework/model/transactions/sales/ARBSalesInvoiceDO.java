...
@Entity
@Table(name="ARB_SALES_INVOICES")
public class ARBSalesInvoiceDO {
	...
	private int deleted;
	@Transient
	private List<ARBSalesInvoiceDetailsDO> detailsList = new ArrayList<ARBSalesInvoiceDetailsDO>();
	...
	public List<ARBSalesInvoiceDetailsDO> getDetailsList() {
		return detailsList;
	}
	public void setDetailsList(List<ARBSalesInvoiceDetailsDO> detailsList) {
